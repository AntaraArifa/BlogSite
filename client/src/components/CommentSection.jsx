      ...
      {currentUser && (
        <form onSubmit={handleSubmit} className="border border-teal-500 rounded-md p-3">
          ...
          <div className="flex justify-between items-center mt-5">
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-blue-400 via-blue-600 to-blue-900 text-white px-4 py-2 rounded-md shadow-md hover:opacity-90 transition"
            >
              Submit
            </button>
          </div>
          {commentError && <div className="mt-5 text-red-500 text-sm">{commentError}</div>}
        </form>
      )}
